...
#define UART2_TX_BUFF_SIZE 	512

/* 数据标志位 */
unsigned char uart2_data_flag   = 0;	/* 数据帧接收完成 */
unsigned int  uart2_data_length = 0;	

u8 uart2_rx_buff[UART2_RX_BUFF_SIZE];
u8 uart2_tx_buff[UART2_TX_BUFF_SIZE];
